...
const SingUp = () => {
  ...
  return (
    <>
      <div className="min-h-screen bg-gray-100 dark:bg-gray-300 text-gray-900 flex justify-center">
        <div className="max-w-screen-xl m-0 sm:m-10 bg-white dark:bg-gray-400 shadow sm:rounded-lg flex justify-center flex-1">
